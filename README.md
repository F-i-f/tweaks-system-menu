...
Or download the [zip file](https://github.com/F-i-f/tweaks-system-menu/releases/download/v24/tweaks-system-menu@extensions.gnome-shell.fifi.org.v24.shell-extension.zip) from the GitHub [releases
page](https://github.com/F-i-f/tweaks-system-menu/releases) and run:

``` shell
gnome-extensions install tweaks-system-menu@extensions.gnome-shell.fifi.org.v24.shell-extension.zip
```
